...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Per-market intraday training with side/size local modeling and cross-market features."
    )
    ...
    parser.add_argument("--name", default="per_market_interactions_side_size")
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable local side/size decomposition: P(negative) + positive-size + negative-size models (default: enabled).",
    )
    parser.add_argument(
        "--side-size-min-rows",
        type=int,
    ...
    latest_path = Path("csv/submission_per_market_interactions_side_size.csv")
