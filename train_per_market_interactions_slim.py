...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=False,
        help="Enable lag-safe dynamic target profiles including dynamic squared-mean and RMS features (default: disabled).",
    )
    parser.add_argument(
        "--use-temporal-regime",
        action=argparse.BooleanOptionalAction,
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable 24h/168h anomaly and z-score features (default: disabled).",
    )
    parser.add_argument(
        "--use-cross-market-rank-features",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable same-timestamp cross-market percentile rank features (default: disabled).",
    )
    parser.add_argument(
        "--use-peak-interactions",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable peak/daytime interaction features (default: disabled).",
    )
    parser.add_argument(
    ...
    latest_path = Path("csv/submission_per_market_interactions_slim.csv")
